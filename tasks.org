* [[elisp:(org-projectile-open-project "Bayesian_Net_Thesis")][Bayesian_Net_Thesis]] [3/5]
  :PROPERTIES:
...
*** TODO reformulate and write down everything in a neat way to prepare for the discussion with Radu
    SCHEDULED: <2021-04-05 Mon 10:00>

*** TODO understand what are the assumptions for the above? global decomposition? etc.? (have to specify MAR property for it).

*** TODO start to write this piece as for the thesis. Like this you can show it to Radu and you will have it ready for the thesis.    
