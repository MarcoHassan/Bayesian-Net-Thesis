...
* Bayesian Networks - Overview and Manuscript Outline
   ...
   subfields[fn:2] attracted the interest of multiple researchers; it
   ...
   factor[fn:1], with a total of ~100'000 published papers on the
...
** Literature Review and Research Outline
   ...
   - STATE HERE THE TWO WAYS FOR SOLVING THE PARAMETER LEARNING - MLE
     AND BAYESIAN APPROACH. 

   - STATE RESEARCH AND BASIC RESULTS IN THE CASE OF COMPLETE AND
     MISSING EVIDENCE

   - STATE RESEARCH AND BASIC RESULTS IN THE CASE OF LIKELIHOOD
     EVIDENCE

   - STATE RESEARCH AND BASIC RESULTS IN THE CASE OF UNCERTAIN
     EVIDENCE
