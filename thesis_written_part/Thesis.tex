...
\label{sec:org5d3207f}


\section{Types of Uncertain Evidence}
\label{sec:org13d4970}
...
by replacing line 7 of \ref{alg:EM-Likelihood} with 
...
\subsection{{\bfseries\sffamily TODO} Write Down Numerical Algorithm for M STEP}
\label{sec:org37551c1}

\section{{\bfseries\sffamily TODO} On Probabilistic Evidence}
\label{sec:orgbf79f43}

Here in theory also very straightforward extension. See the
\cite{Mrad_2015} paper. For at least one case there is a clear pattern
that you can use.
