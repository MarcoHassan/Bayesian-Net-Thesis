...
\section{Bayesian Networks - History and Recent Developments}
\label{sec:orga91630e}
...
\begin{itemize}
\item HISTORY\ldots{} WHY BAYESIAN NETWORKS WERE INTRODUCED FIRST.
\end{itemize}
...
\subsection{{\bfseries\sffamily TODO} have to rigorously define here what a Bayesian Network is}
\label{sec:orgca57610}

\subsection{{\bfseries\sffamily TODO} state the difference between types of networks. global parameter sharing and a priori independent}
\label{sec:org127b9f9}



\section{Thesis Outline}
\label{sec:orgc13e3c5}
