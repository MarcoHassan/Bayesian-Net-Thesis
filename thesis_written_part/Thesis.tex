...
\label{sec:org95dfc5e}
\item {\bfseries\sffamily TODO} REASON ON HOW JEFFERY's method can work with the EM algorithm
\label{sec:org75626d1}
\item {\bfseries\sffamily TODO} until 3.2 it is nice; I like it and I think it is well like this.
\label{sec:orgc24d128}
